...
//Textdraws
PublicTD[0] = TextDrawCreate(183.000000, 157.000000, "~g~Achievement_Completed");
TextDrawFont(PublicTD[0], 2);
TextDrawLetterSize(PublicTD[0], 0.529166, 2.000000);
...
PublicTD[1] = TextDrawCreate(265.000000, 204.000000, "Richest Player");
...
TextDrawColor(PublicTD[1], -65281);
TextDrawBackgroundColor(PublicTD[1], 255);
TextDrawBoxColor(PublicTD[1], 88);
